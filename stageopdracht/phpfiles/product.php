...
<body>
   ...
   ?>
    ...
    <h2>Zoek voor producten of laat het veld leeg om alle klanten te bekijken.</h2>
    <form method="POST" action="qry-product.php">
        <input type="search" name="searchprod" id="searchprod" placeholder="search">
